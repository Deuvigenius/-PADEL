...
class RentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rent" do
    assert_difference("Rent.count") do
      post rents_url, params: { rent: { padel_court_id: @rent.padel_court_id, start_time: @rent.start_time, user_id: @rent.user_id } }
    end
  ...
  test "should update rent" do
    patch rent_url(@rent), params: { rent: { padel_court_id: @rent.padel_court_id, start_time: @rent.start_time, user_id: @rent.user_id } }
